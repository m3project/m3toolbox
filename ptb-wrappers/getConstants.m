...
consts.SILENT_PTB  = 1;        % when set, limits PTB msgs to crit1ical errors
...
% The code snipper below will lookup the appropriate SCREEN_ID per PC

screenIDs = {{'READLAB14', 1}, {'VIVEKPC', 2'}, {'SLYTHERIN', 0}, {'IONHWB62', 0}, {'READLAB21', 2}, {'READLAB16', 1}};
