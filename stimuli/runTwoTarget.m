...
% blockWidth= 8; %Block width in degrees

blockHeight=2; %block height in degrees

xOffset= 30; %distance from each stimulus to centre in degrees
% xOffset= 65; %distance from each stimulus to centre in degrees
...
timeStep=0.025;%how often the stimulus should advance in seconds
...
renderTwo = 1; % 1 to enable the second phase of the animation
